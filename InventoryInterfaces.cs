...
namespace WebServiceTutorial
{
    ...
    //    //private Rectangle[] Sq = new Rectangle[1];
    //    private List<Rectangle> m_ar;//= new ArrayList();

    //    public Boolean initialize()
    //    {
    //        m_ar = new List<Rectangle>();
    //        return true;
    //    }

    //    public List<Rectangle> ar
    //    {
    //        get
    //        {
    //            return m_ar;
    ...
    //    public string addRectangle(Rectangle myRectangle)
    //    {
    //        try
    //        {
    //            m_ar.Add(myRectangle);
    //            return "True";
    //        }
    //        catch(Exception ex)
    //        {
    ...
    public struct VersePrice
    {
        ...
        ////private Rectangle[] Sq = new Rectangle[1];
        //private ArrayList m_ar;//= new ArrayList();
        ...
        //public string addVerse(Verses myVerses)
        //{
        //    try
        //    {
        //        m_ar.Add(myVerses);
